...
qAM = {
	...
	errorModal: function(data){
		...
		case 3://conflict
			...
			var info = $('<div class="alert alert-info"/>').text(data.resource+' '+data.key+conflictMessage);
			b.append(info);
			break;
		default://generic
		...
		var email = 'mailto:support@quix.it?subject=segnalazione%20errore&body='+encodeURIComponent(data.frmktrace).substring(0, 1500) +'...';//tanto � molto pi� lunga
