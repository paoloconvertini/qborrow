	...
	<div class="row">
		<div class="col-xs-12">
			<div class="panel panel-danger">
				<div class="panel-heading" ><h4 class="panel-title"><s:text name="error.internal.title" />:&nbsp;<s:text name="lockManager.lockRemovedTitle"/>&nbsp;<span class="glyphicon glyphicon-lock"></span></h4></div>
				<div class="panel-body">
					<div class="row">
						<div class="col-xs-12 col-sm-8 col-sm-offset-2">
							<p><s:text name="lockManager.lockRemovedMessage"/></p>
							<p><s:text name="lockManager.lockRemovedSmallMessage"/></p>
						</div>
					</div>
				</div>
