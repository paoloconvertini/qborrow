  	...
  	<body ng-app="qborrow"> 
  		<div class="frameworkGlobalDiv"> 
	  		...
	  		<div class="frameworkRow"  >
  				...
  				<div class="frameworkMainCell" ng-controller="qxSoggettoController" ng-include="scopeController.selectedPage">
					
  				</div>
  				<script type="text/ng-template" id="list"><jsp:include page="_soggetto.jsp" /></script>
  				<script type="text/ng-template" id="edit"><jsp:include page="_soggettoEdit.jsp" /></script>
